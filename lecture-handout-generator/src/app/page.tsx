...
export default async function HomePage() {
  ...
  if (process.env.LOCAL_DEMO_MODE === "true") {
    const demoProjects: HandoutProject[] = [
      { id: "demo-01", name: "2026秋季·0升1五讲讲义", grade: "0升1", lessonCount: 5, teachingYear: 2026, teachingYearConfirmed: true, outputKinds: ["lesson_student", "combined_student", "parent_manual"], status: "layout_review", pinned: true, updatedAt: "今天" },
      { id: "demo-02", name: "二年级读写课·拼音审核", grade: "1升2", lessonCount: 5, teachingYear: 2026, teachingYearConfirmed: true, outputKinds: ["lesson_student", "combined_answers"], status: "text_review", pinned: false, updatedAt: "昨天" }
    ];
