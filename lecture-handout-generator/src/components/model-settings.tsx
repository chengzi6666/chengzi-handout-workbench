      ...
      <div className="settings-grid">
        ...
        <section className="panel">
          ...
          <form className="provider-form" onSubmit={submit}>
            <div className="group-model-preset"><strong>GPT-5.4（推荐）</strong><span>集团可用 · 1M 长上下文 · 图片理解 · 结构化 JSON</span><small>接口地址：ai-service.tal.com/claw</small></div>
            ...
            <p className="key-help">请在未来云 → 星图应用开发平台 → Token Plan → 模型一键申请中开通 <b>gpt-5.4</b> 后粘贴 Key。Key 会使用 AES 加密保存。</p>
