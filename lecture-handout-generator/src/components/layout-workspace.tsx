...
export function LayoutWorkspace({
  ...
  const savedRichPreview = usableRichPreview(richPreviewHtml[previewKey]);
  const currentRichPreview = previewKind === "parent" && savedRichPreview && !isCurrentParentRichPage(savedRichPreview, parentPage)
    ? undefined
    : savedRichPreview;
