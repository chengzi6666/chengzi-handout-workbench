...
Page({
  data: { loading:true, error:"", book:null, pages:[], index:0, current:null, blocks:[], landscape:false },
  onLoad(options) {
  ...
  onShareAppMessage(){return{title:(this.data.book&&this.data.book.title)||"读写综合能力提升电子书",path:"/pages/book/index?grade="+this.grade+"&slug="+this.slug,imageUrl:(this.data.book&&(this.data.book.shareCoverUrl||this.data.book.coverUrl))||""}}
});
